...
@interface ModJournalismStyle1Switch ()
...
@implementation ModJournalismStyle1Switch
- (instancetype)init
{
    self = [super init];
    if (self) {
        
        [NSException raise:@"ModJournalismStyle1SwitchInitException" format:@"Init call is prohibited, use initWithStringsArray: method"];
    }
...
{
    // to do
    return [[ModJournalismStyle1Switch alloc] initWithStringsArray:strings];
}
